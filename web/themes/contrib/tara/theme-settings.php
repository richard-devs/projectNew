...
function tara_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  ...
  $form['upgrade'] = [
    ...
    '#description'  => t('<h3>Upgrade To TaraPro For $39 Only.</h3>'),
    '#group' => 'tara',
  ];
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://drupar.com/theme/tara" target="_blank">Theme Homepage</a> || <a href="https://tara.drupar.com/" target="_blank">Theme Demo</a> || <a href="https://drupar.com/doc/tara/" target="_blank">Theme Documentation</a> || <a href="https://drupar.com/doc/tara/support/" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To TaraPro for $39 only'),
  ...
  $form['color']['theme_color'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Color'),
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/tarapro" target="_blank">Buy TaraPro for $39 only.</a>'),
  ];
...
// Social -> TaraPro Features
  $form['social']['mastodon'] = [
    '#type'        => 'details',
    '#title'       => t("mastodon"),
  ];
  $form['social']['mastodon']['mastodon_url'] = [
      '#type'          => 'textfield',
      '#title'         => t('mastodon page url'),
      '#description'   => t("This feature is available in TaraPro."),
      '#disabled'   => TRUE,
  ];
  $form['social']['tiktok'] = [
    '#type'        => 'details',
  ...
  $form['social']['bluesky']['bluesky_url'] = [
      '#type'          => 'textfield',
  ...
  $form['social']['discord']['discord_url'] = [
      '#type'          => 'textfield',
  ...
  $form['social']['social_new_icon']['social_new_icon_code'] = [
    ...
    '#disabled'   => TRUE,
    '#description'   => t('This feature is available in TaraPro. <a href="https://drupar.com/theme/tarapro/" target="_blank">Buy TaraPro for $39 only.</a>'),
  ];
  /**
   * Slider Settings
   */
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#description'   => t('<p>Recommended image size is 1920px (width) X 1080px (height).</p><p>Tara theme has limitation of single image for slider. Separate image for each slide is available in TaraPro. <a href="https://drupar.com/theme/tarapro" target="_blank">Buy TaraPro for $39 only.</a></p>'),
  ];
  ...
  // Slider - Arrow
  $form['slider']['slider_arrow_field'] = [
    '#type'          => 'fieldset',
    '#title'         => t('Slider Arrow'),
  ];
  $form['slider']['slider_arrow_field']['slider_arrow'] = [
    '#type'          => 'select',
    '#title'         => t('Slider Arrow'),
    '#options' => array(
      'true' => t('Show'),
      'false' => t('Hide'),),
    '#default_value' => theme_get_setting('slider_arrow', 'tara'),
    '#description'   => t('Show or hide slider arrow navigation that appears at the bottom of slider.'),
  ];
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'tara'),
    '#description'   => t('Please refer to this <a href="https://drupar.com/doc/tara/hero-slider/" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  $form['slider']['slider_faq'] = [
    ...
    <p>You can create slider for the frontpage only. TaraPro theme has feature to create slider for inner pages also. <a href="https://drupar.com/theme/tarapro" target="_blank">Buy TaraPro for $39 only.</a></p>
    <hr />
  ...
  $form['content_tab']['home_content'] = [
    ...
    <li><a href="https://drupar.com/doc/tara/create-homepage/" target="_blank">How To Create Homepage</a></li>
    <li><a href="https://drupar.com/doc/tara/add-homepage-content/" target="_blank">How to add content on homepage</a></li>
  </ul>'),
    '#group' => 'content_tab',
  ];
  // Content -> Page loader
  ...
  $form['content_tab']['shortcode'] = [
    '#type'        => 'details',
    '#title'       => t('Shortcodes'),
    '#description' => t('Tara theme has some custom shortcodes. You can create some styling content using these shortcodes.<br />Please visit this tutorial page for details. <a href="https://drupar.com/doc/tara/custom-shortcodes/" target="_blank">Shortcodes in Tara theme</a>.'),
    '#group' => 'content_tab',
  ];
  // Content -> node
  ...
  $form['content_tab']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description' => t('<h3>Share Page On Social Media</h3><p>This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/tarapro" target="_blank">Buy TaraPro for $39 only.</a></p>'),
    '#group' => 'content_tab',
  ];
  ...
  $form['insert_codes']['css']['css_code'] = [
    ...
    '#description'   => t('Add your own CSS codes here to customize the appearance of your site. Please refer to this tutorial for detail: <a href="https://drupar.com/doc/tara/custom-css/" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>We have a detailed documentation about how to use theme. Please read the <a href="https://drupar.com/doc/tara/" target="_blank">Tara Theme Documentation</a>.</p>
    <hr />
    <h4>Open An Issue</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<a href="https://demo2.drupar.com/tarapro/" target="_blank">TaraPro Demo</a> | <a href="https://drupar.com/theme/tarapro" target="_blank">Purchase TaraPro for $39 only</a>'),
    '#description' => t("$img<br /><a href='https://demo2.drupar.com/tarapro/' target='_blank'>TaraPro Demo</a> | <a href='https://drupar.com/theme/tarapro' target='_blank'>Purchase TaraPro for $39 only</a>"),
  ];
// End form.
}
